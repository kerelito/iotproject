...
- **Dostęp do danych historycznych** – tabela z ostatnimi 30 pomiarami.
...
## Założenia działania
- Dane są odświeżane cyklicznie co 3 sekundy, a wykresy pokazują przesuwne okno ostatnich 30 próbek.
- W prototypie dane są symulowane realistycznie (łagodne zmiany zamiast skoków losowych).
- Wizualizacja obejmuje trzy osobne wykresy (temperatura, wilgotność, ciśnienie) + dashboard.
